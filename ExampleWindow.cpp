...
:Window(width, height) {
	...
	_treeOne = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "TreeOne.png"),
			SDL_DestroyTexture
	);

	_treeTwo = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "TreeTwo.png"),
			SDL_DestroyTexture
	);
	...
	_airplane = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "bird3.png"),
			SDL_DestroyTexture
	);

	_helicopter = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "bird.png"),
			SDL_DestroyTexture
	);

	_helicopterLeft = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "bird2.png"),
			SDL_DestroyTexture
	);
	...
	_butterflyLeft = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "bird4.png"),
			SDL_DestroyTexture
	);

	_butterflyRight = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "bird5.png"),
			SDL_DestroyTexture
	);

	_loog1 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "loog1.png"),
			SDL_DestroyTexture
	);

	_loog2 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "loog2.png"),
			SDL_DestroyTexture
	);

	_loog3 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "loog3.png"),
			SDL_DestroyTexture
	);
	...
	_mountain1 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "m1.png"),
			SDL_DestroyTexture
	);

	_mountain2 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "m2.png"),
			SDL_DestroyTexture
	);

	_mountain3 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "m3.png"),
			SDL_DestroyTexture
	);

	_mountain4 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "m4.png"),
			SDL_DestroyTexture
	);

	_mountain5 = std::shared_ptr<SDL_Texture>(
			IMG_LoadTexture(_renderer.get(), "m5.png"),
			SDL_DestroyTexture
	);
}
